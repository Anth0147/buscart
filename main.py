...
================================================================
Automatización de login masivo en Visor Clientes Movistar:
- Integrado con proxy_config.py (SuperProxy / IPs rotativas de Perú o IP Local).
- Integrado con whatsapp_notifier.py (Alertas de login exitoso, resumen y error crítico).
- Integrado con state_manager.py (Checkpoints y auto-recuperación ante errores).
- Detección de errores críticos (2 WAFs seguidos, 2 pantallas en blanco, 2 timeouts).
"""
...
def main(checkpoint_data=None):
    print("""
============================================================
  LOGIN AUTOMATION — VISOR CLIENTES MOVISTAR
  IPs rotativas de Perú + N hilos/batch + Checkpoints
============================================================
    """)
